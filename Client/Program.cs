// Program.cs - Clienttoepassing die de service aanroept
...
namespace Client
{
    ...
    {
        /// <summary>
        /// Roept de service aan, en toont de output in de console.
        /// </summary>
        /// <param name="args"></param>
        static void Main(string[] args)
        {
            using (var client = new HelloServiceReference.HelloServiceClient())
            {
